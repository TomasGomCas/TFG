...
public class Controller {
	...
	public Integer compleja(@RequestParam(value="valor1") Integer valor1,@RequestParam(value="valor2") Integer valor2,@RequestParam(value="valor3") Integer valor3,@RequestParam(value="valor4") Integer valor4)
	{
